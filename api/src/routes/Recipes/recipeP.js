...
router.post('/', async (req,res) => {
    ...
    if(score < 0 || score > 100) return res.send({message: 'score must be between 0 -100'})
    if(healthScore < 0 || healthScore > 100) return res.json({message:'healtScore must be between 0 -100'})
